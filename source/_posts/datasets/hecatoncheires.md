...
並且因為還沒有機制可以解除 DEBUFF 的情況下，使開場時的傷害會變得非常低，因此建議在入場時能 **將所有防禦穿透總和超過 500%（主 + 空 + 背 + 浮 >= 500%）**
...
<tr>
    ...
    <td align="left"><strong>智慧之光</strong> 發動時，於使用者周圍產生一區域對敵人造成傷害。此傷害為<strong>真實傷害</strong>，並且受增傷 / 暴擊影響。<br>煮水補充：基礎傷害值為 1000 萬。</td>
</tr>
