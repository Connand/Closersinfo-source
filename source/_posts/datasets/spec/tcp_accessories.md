...
tags: 資料紀錄
category: [遊戲資料,能力提升]
cover: https://i.imgur.com/slEdo0F.png
...
|軍團長|道具圖|能力值|
|:-:|:-|:-|
| 巴爾團隊副本 |{% inlineImg https://i.imgur.com/4kmLC2r.png 32px %}{% inlineImg https://i.imgur.com/jqaNdWq.png 32px %}{% inlineImg https://i.imgur.com/N2VLqxQ.png 32px %}|物理/魔法攻擊力+800<br>物理/魔法爆傷+80%<br>食蟲增傷+40%
...
|軍團長|道具圖|取得方式|
|:-:|:-:|:-:|
| 巴爾團隊副本 |{% inlineImg https://i.imgur.com/4kmLC2r.png 32px %}{% inlineImg https://i.imgur.com/jqaNdWq.png 32px %}{% inlineImg https://i.imgur.com/N2VLqxQ.png 32px %}|[巴爾團隊副本](https://closersinfo.xyz/datasets/Balt_Assault/)
...
|區域|道具圖|能力值|
|:-:|:-:|:-|
| 仁川港 |{% inlineImg https://i.imgur.com/RFEhdSq.png 32px %}{% inlineImg https://i.imgur.com/firz0BV.png 32px %}{% inlineImg https://i.imgur.com/IfblYK2.png 32px %}{% inlineImg https://i.imgur.com/TJ8zX1H.png 32px %}<br>帽子 <font color=#f00>臉上 手臂</font>  腿部|2件：物理及魔法攻擊力350、三爆傷35%<br>3件：物理及魔法攻擊力350、主爆傷35%、掉落道具35%、超能凝聚速度100% |
...
|區域|道具圖|取得方式|
|:-:|:-:|:-|
| 仁川港|{% inlineImg https://i.imgur.com/RFEhdSq.png 32px %}{% inlineImg https://i.imgur.com/firz0BV.png 32px %}{% inlineImg https://i.imgur.com/IfblYK2.png 32px %}{% inlineImg https://i.imgur.com/TJ8zX1H.png 32px %}<br>帽子 <font color=#f00>臉上 手臂</font>  腿部|[製作](https://closersinfo.xyz/datasets/IncheonPort_Chromite/#%E8%A3%BD%E4%BD%9C%E6%9D%90%E6%96%99)
