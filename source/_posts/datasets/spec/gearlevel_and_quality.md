...
|裝備基礎數值<br>從拍賣或升級預覽|品級100%
|:-:|:-:
|![](https://i.imgur.com/rI3pofo.png)|![](https://i.imgur.com/emczcUJ.png)

- 備註:品質與數值公式為 ( <font color=red>武器基礎數值x[1.3+(1+武器品質)*0.0015]</font> )
...
- 大多數關卡會標示 "裝備等級" 
**<font color=green>若高於標示的裝備等級，則進入副本會獲得增傷BUFF</font>；若低於則~~會有減傷以及被擊傷害增加的DEBUFF，且~~<font color=red>不能使用 "尋找組隊F6" 功能</font>** 
