...
|詞條|魔龍傳說|剪刀傳說
|:-|:-:|:-:
|基礎攻擊力(0%)<br>權杖、鞭子<br>燈籠<br>雙劍|<br>5250<br>6523<br>3977|<br>6387
|**<font color=red>基礎攻擊力(100%)</font><br>權杖、鞭子<br>燈籠<br>雙劍**|<br>7620 (估算)<br>9468<br>5772 (估算)|<br>9069(估算)
|**攻擊速度**<br>權杖、鞭子<br>燈籠<br>雙劍|<br>1.0<br>0.8<br>1.2|<br>0.9
|--- <font color=#8B8000>以下黃字數值</font>|---|---
|物理/魔法暴擊傷害|210%|230%
|空中/背擊/浮空暴擊傷害|105%|115%
|空中/背擊/浮空增加傷害|80%|80%
|**<font color=red>特殊能力 (下面說明)</font><br>權杖<br>鞭子<br>燈籠<br>雙劍**|<br>**[魔法]<br>[盤繞]<br>[智慧之光]<br>[多重斬擊]**|<br>**[荒誕剪刀]**
...
|詞條|{% inlineImg https://i.imgur.com/p6EoamX.png 48px %}{% inlineImg https://i.imgur.com/Mf2wYXM.png 48px %}<br><font color=red>物理</font> / <font color=blue>魔法</font>|{% inlineImg /img/gear/count_D/HQ_OPERA_LEGEND_MODULE_BOOSTER_1.PNG 48px %}{% inlineImg /img/gear/count_D/HQ_OPERA_LEGEND_MODULE_REGULATOR_1.PNG 48px %}<br><font color=red>物理</font> / <font color=blue>魔法</font>|{% inlineImg https://i.imgur.com/c9GbsJP.png 48px %}<br><font color=purple>混合</font>|{% inlineImg /img/gear/count_D/HQ_OPERA_LEGEND_MODULE_TUBE_1.PNG 48px %}<br><font color=purple>混合</font>
|:-|:-:|:-:|:-:|:-:
|基礎攻擊力(0%)|2100|2600|1890|2340
|**<font color=red>基礎攻擊力(100%)</font>**|3048|3692(估測)|2743|3322(估測)
|--- <font color=#8B8000>以下黃字數值</font>|---|---|---|---
|暴擊傷害|315%|390%|284%|351%
|--- <font color=red>以下兩件套裝效果</font>|---|---|---|---
|攻擊力|3300|3900|2970|3510
|暴擊率|50%|50%|50%|50%

- **<font color=red>史詩</font>**

|詞條|{% inlineImg /img/gear/count_D/HQ_OPERA_EPIC_MODULE_BOOSTER_1.PNG 48px %}{% inlineImg /img/gear/count_D/HQ_OPERA_EPIC_MODULE_REGULATOR_1.PNG 48px %}<br><font color=red>物理</font> / <font color=blue>魔法</font>|{% inlineImg /img/gear/count_D/HQ_OPERA_EPIC_MODULE_TUBE_1.PNG 48px %}<br><font color=purple>混合</font>
|:-|:-:|:-:
|基礎攻擊力(0%)|2900|2610
|**<font color=red>基礎攻擊力(100%)</font>**|4118(估測)|3706(估測)
|--- <font color=#8B8000>以下黃字數值</font>|---|---
|暴擊傷害|435%|392%
|--- <font color=red>以下兩件套裝效果</font>|---|---
|攻擊力|4350|3920
...
|獎勵{% inlineImg /img/gear/count_D/HQ_201505_RESOURCE.PNG 48px %}|1 |2 |3 |4 |5 |6 |
