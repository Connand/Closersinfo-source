...
|浮空暴擊傷害減少|0%|400%<br>**1600**|600%<br>**2400**|800%<br>**3200**|
<!-- endtab -->
<!-- tab 敵人強化-->
|項目|0|1|2|3|
|:-|:-:|:-:|:-:|:-:|
|- **敵人強化**|||||
|每秒恢復血量|0%|0.02%<br>**1000**|0.05%<br>**2000**|0.1%<br>**3000**|
|暴擊傷害抵抗增加|0%|400%<br>**2000**|600%<br>**3000**|800%<br>**4000**|
|增加物理攻擊力|0%|50%<br>**500**|75%<br>**750**|100%<br>**1000**|
|增加魔法攻擊力|0%|50%<br>**500**|75%<br>**750**|100%<br>**1000**|
|增加最大血量|0%|10%<br>**1000**|20%<br>**2000**|40%<br>**4000**|
<!-- endtab -->
{% endtabs %}
...
|:-:|:-:|:-:|:-:|:-:|:-:|
|1000|{% inlineImg https://i.imgur.com/tJuge7P.png 40px %} 5|{% inlineImg /img/material/HQ_10012_RESOURCE_EPIC.png 40px %} 100|{% inlineImg /img/material/HQ_10015_RESOURCE_UNCOMMON.png 40px %} 100|||
|2000|{% inlineImg https://i.imgur.com/tJuge7P.png 40px %} 10|{% inlineImg /img/material/HQ_10012_RESOURCE_EPIC.png 40px %} 150|{% inlineImg /img/material/HQ_10015_RESOURCE_UNCOMMON.png 40px %} 150|||
|4000|{% inlineImg https://i.imgur.com/tJuge7P.png 40px %} 15|{% inlineImg https://i.imgur.com/IikTgnm.png 40px %} 1|{% inlineImg /img/material/malek_crysyal.png 40px %} 7|||
|6000|{% inlineImg https://i.imgur.com/9VEgQzQ.png 40px %} 1|{% inlineImg https://i.imgur.com/IikTgnm.png 40px %} 1|{% inlineImg /img/material/malek_crysyal.png 40px %} 10|||
|8000|{% inlineImg https://i.imgur.com/9VEgQzQ.png 40px %} 2|{% inlineImg https://i.imgur.com/LE2TT8Q.png 40px %} 1|{% inlineImg /img/material/malek_crysyal.png 40px %} 15|||
|10000|{% inlineImg https://i.imgur.com/9VEgQzQ.png 40px %} 3|{% inlineImg /img/material/HQ_799903816_GUST_INVALID_NA.PNG 40px %} 2<br>**威嚴自選箱**|{% inlineImg /img/material/malek_crysyal.png 40px %} 20|||
|12000|{% inlineImg https://i.imgur.com/9VEgQzQ.png 40px %} 5|{% inlineImg /img/material/dance_effect.png 40px %} 1<br>**舞蹈特效自選箱**|{% inlineImg /img/material/malek_diamond.png 40px %} 8|||
|15000|{% inlineImg https://i.imgur.com/9VEgQzQ.png 40px %} 8|{% inlineImg /img/material/awaken_effect2.png 40px %} 1<br>**覺醒特效自選箱**|{% inlineImg /img/material/malek_diamond.png 40px %} 10|{% inlineImg https://i.imgur.com/RuCJ0xW.png 40px %} 1<br>**背部飾品**||
|18000|{% inlineImg https://i.imgur.com/9VEgQzQ.png 40px %} 13|{% inlineImg https://i.imgur.com/WxaqM1W.png 40px %} 1|{% inlineImg /img/material/malek_diamond.png 40px %} 15|{% inlineImg https://i.imgur.com/CI7SQ0T.png 40px %} 1||
|21000|{% inlineImg https://i.imgur.com/9VEgQzQ.png 40px %} 20|{% inlineImg https://i.imgur.com/iNlEJ3D.png 40px %} 1<br>**寵物自選箱**|{% inlineImg /img/material/malek_diamond.png 40px %} 20|{% inlineImg /img/chip/T4_platinum.png 40px %} 2<br>**鉑金T4自選箱**|{% inlineImg https://i.imgur.com/QmbwE6H.png 40px %} 1|
|24000|{% inlineImg https://i.imgur.com/wtRhJeI.png 40px %} 1|||||
|27000|{% inlineImg https://i.imgur.com/cvNwdSv.png 40px %} 1|||||

- 部分外觀道具展示如下（**均為角色制**）

<div class="dec">

|名稱|{% inlineImg https://i.imgur.com/QmbwE6H.png 48px %}<br>姓名標籤券：封鎖慾望之印|{% inlineImg https://i.imgur.com/CI7SQ0T.png 48px %}<br>無限慾望的威嚴|{% inlineImg https://i.imgur.com/wtRhJeI.png 48px %}<br>客製化零件：閃亮泡沫|{% inlineImg https://i.imgur.com/cvNwdSv.png 48px %}<br>外觀編制券：無限慾望|
|:-:|:-:|:-:|:-:|:-:|
|裝備效果|{% inlineImg https://i.imgur.com/LKhurZr.png 100px %}|{% inlineImg https://i.imgur.com/SNgGUdd.gif 200px %}|{% inlineImg https://i.imgur.com/imlT2Ce.gif 200px %}|{% inlineImg https://i.imgur.com/ymsRnbE.gif 200px %}|
</div>
