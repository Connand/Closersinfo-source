...
+ {% inlineImg https://i.imgur.com/iOcFia8.png 64px %} 烈風的漏洞塊
	> 用來製作上面兩個用的
	> 一場VH達斯特可獲得4個
+ {% inlineImg https://i.imgur.com/bIENHnS.png 64px %} 不朽的漏洞塊
	> 用來超越
	> 一場VH路西法可獲得4個
+ {% inlineImg https://i.imgur.com/PUokuSV.png 64px %} 至高因子
	> 用來升級至高圓盤與覺醒膠囊
	> 一場路西法可獲得3個

## 副本資訊
- 類型：{% inlineImg https://i.imgur.com/t8j9844.png 64px %}使徒型，普通與VH共用入場次數
- 新裝備裝備等級：148(賽騰城) -> 161 -> 177 -> 201
- **另一個路西法參考攻略** {% btn 'https://forum.gamer.com.tw/C.php?bsn=23655&snA=9154',副本攻略,far fa-hand-point-right,outline blue larger %}

|副本|等級|建議戰力|裝備等級|消耗疲勞|入場限制|人數|
|:-:|:-:|:-:|:-:|:-:|:-:|:-:|
|狼的戰術建議|89|1100萬| - | **<font color=#ff0000>50</font>** |角色1次|1~4人|
|達斯特|89|1200萬| 160 | 10 |角色1次|建議4人|
|達斯特VH|89|**<font color=#ff0000>1800萬</font>**| 163 | 10 |角色1次|建議4人|
|另一個路西法|90|1600萬| 160 | 10 |角色1次|建議4人|
|另一個路西法VH|90|**<font color=#ff0000>2200萬</font>**| 172 | 10 |角色1次|建議4人|
...
| ![金幣](https://i.imgur.com/bRFx7v6.png) | ![粉塵](https://i.imgur.com/qMKcQoy.png) |  ![結晶](https://i.imgur.com/oZ9yEkN.png) | ![大彩](https://i.imgur.com/XSUcWuc.png) | ![大光](https://i.imgur.com/uUaELFR.png) |
|:-:|:-:|:-:|:-:|:-:|
|12,000,000|400 個|2 個|200 個|120 個|
...
<!-- tab 農保底總和-->
**<font color=#ff0000>約需打 141 場VH路西法必殺程式</font>**
...
<!-- tab 彩罐法總和-->
**<font color=#ff0000>約需打 36 場VH路西法必殺程式(任務會多給)</font>**
...
|:-:|:-:|:-:|:-:|:-:|:-:|:-:|
|1,700,000|75 個|250 個|150 個|260 個|145 個|19 個|
<!-- endtab -->
{% endtabs %}
...
<!-- tab II階-->
{% inlineImg https://i.imgur.com/I0TC8Og.png 64px %} 最大HP +1000

製作材料：{% inlineImg https://i.imgur.com/EM4TBaH.png 64px %} + {% inlineImg https://i.imgur.com/bRFx7v6.png 64px %}10,000,000 + {% inlineImg https://i.imgur.com/PUokuSV.png 64px %}12
...
<!-- tab III階-->
{% inlineImg https://i.imgur.com/Gcv9h2h.png 64px %} 最大HP +1500

製作材料：{% inlineImg https://i.imgur.com/I0TC8Og.png 64px %} + {% inlineImg https://i.imgur.com/bRFx7v6.png 64px %}20,000,000 + {% inlineImg https://i.imgur.com/PUokuSV.png 64px %}24
...
<!-- tab IV階-->
{% inlineImg https://i.imgur.com/CqcqdOh.png 64px %} 最大HP +2000

製作材料：{% inlineImg https://i.imgur.com/Gcv9h2h.png 64px %} + {% inlineImg https://i.imgur.com/bRFx7v6.png 64px %}30,000,000 + {% inlineImg https://i.imgur.com/PUokuSV.png 64px %}36
...
<!-- tab V階-->
{% inlineImg https://i.imgur.com/reeIf3V.png 64px %} 最大HP +2500

製作材料：{% inlineImg https://i.imgur.com/CqcqdOh.png 64px %} + {% inlineImg https://i.imgur.com/bRFx7v6.png 64px %}40,000,000 + {% inlineImg https://i.imgur.com/PUokuSV.png 64px %}72
...
<!-- tab VI階-->
{% inlineImg https://i.imgur.com/9Vdlzsr.png 64px %} 最大HP +3000

製作材料：{% inlineImg https://i.imgur.com/reeIf3V.png 64px %} + {% inlineImg https://i.imgur.com/bRFx7v6.png 64px %}50,000,000 + {% inlineImg https://i.imgur.com/PUokuSV.png 64px %}108
...
至此，總材料為：{% inlineImg https://i.imgur.com/bRFx7v6.png 64px %}150,000,000 + {% inlineImg https://i.imgur.com/PUokuSV.png 64px %}252 (84場路西法)
<!-- endtab -->
