...
<!-- tab 黑羊小隊{% inlineImg https://imgur.com/8o74x8X.png 32px %} -->

{% tabs 角色介紹 %}
<!-- tab 李世河(Seha) {% inlineImg https://imgur.com/4ZMfJRF.png 32px %} -->
...
<!-- tab 李雪菲(Seulbi) {% inlineImg https://imgur.com/WS7Q2WM.png 32px %} -->
...
<!-- tab 徐維莉(Yuri) {% inlineImg https://imgur.com/YmZepGm.png 32px %} -->
...
<!-- tab J {% inlineImg https://imgur.com/2UoyyST.png 32px %} -->
...
<!-- tab 米斯特汀(Misteltein) {% inlineImg https://imgur.com/96cgCOL.png 32px %} -->
...
<!-- tab 紅狼小隊{% inlineImg https://imgur.com/59yfkuV.png 32px %} -->

{% tabs 角色介紹 %}
<!-- tab 納塔(Nata) {% inlineImg https://imgur.com/jHhDerE.png 32px %} -->

**<font size=5 color=#800080>納塔 (HUNTER)</font>**  **<font size=4 color=#800080 style="float: right; padding-right: 50px">_Nata / 나타_</font>**

正式開放日期：2015/07/16(韓版) 2017/04/27(台版)
...
<!-- tab 蕾比雅(Levia) {% inlineImg https://imgur.com/82NfQra.png 32px %} -->
...
<!-- endtab -->
<!-- tab 哈比(Harpy) {% inlineImg https://imgur.com/6mstCwC.png 32px %} -->
...
<!-- endtab -->
<!-- tab 緹娜(Tina) {% inlineImg https://imgur.com/Y3HopTq.png 32px %} -->
...
<!-- endtab -->
<!-- tab 薇歐莉特(Violet) {% inlineImg https://imgur.com/dKV2PsG.png 32px %} -->
...
<!-- tab 夜梟小隊{% inlineImg https://imgur.com/b5nCmP9.png 32px %} -->

{% tabs 角色介紹 %}
<!-- tab 沃爾夫姜(Wolgang) {% inlineImg https://imgur.com/AvLRjH4.png 32px %} -->
...
<!-- tab 露娜(Luna) {% inlineImg https://imgur.com/e9tkBcP.png 32px %} -->
...
<!-- tab 索瑪(Soma) {% inlineImg https://imgur.com/pGDXIm7.png 32px %} -->
...
<!-- tab 白(Bai) {% inlineImg https://imgur.com/w5Y7q21.png 32px %} -->
...
<!-- tab 賽特(Seth) {% inlineImg https://imgur.com/GagCZmr.png 32px %} -->
...
<!-- tab 嚙鼠小隊{% inlineImg https://imgur.com/r0zYVXk.png 32px %} -->

{% tabs 角色介紹 %}
<!-- tab 未來(Mirae) {% inlineImg https://imgur.com/lnX4eFy.png 32px %} -->
...
<!-- tab 金徹斯(Chulsoo) {% inlineImg https://imgur.com/MM8lDrC.png 32px %} -->
...
> 使用兩把手槍和一把散彈槍，就像銀色的子彈般威脅著敵人生命的遠距離攻擊型超能力者。 某事件後失去記憶，被遺棄在風雨交加的廢墟島某處。 幸好被島嶼的信差葉子發現，並給了他一個新名字－金徹斯。 至此，這個男人迎來了新的開始。
...
<!-- tab 銀河(Eunha) {% inlineImg https://imgur.com/23fifYi.png 32px %} -->
...
<!-- tab 露西(Lucy) {% inlineImg https://imgur.com/7WZ7JDq.png 32px %} -->
...
<!-- tab 愛里(Aeri) {% inlineImg https://imgur.com/1lvAk2l.png 32px %} -->
